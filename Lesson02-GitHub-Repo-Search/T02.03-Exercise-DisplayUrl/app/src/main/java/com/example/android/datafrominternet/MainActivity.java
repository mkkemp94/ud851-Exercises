...
public class MainActivity extends AppCompatActivity {
    ...
    public void makeGithubSearchQuery() {
        ...
        String githubSearchQuery = mSearchBoxEditText.getText().toString().trim();
        Log.v(MainActivity.class.getName(), "Query: " + githubSearchQuery);

        URL githubSearchURL = NetworkUtils.buildUrl(githubSearchQuery);
        Log.v(MainActivity.class.getName(), "URL: " + githubSearchURL.toString());
