...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    /* List Item Click Lister variable to instantiate interface below, final, must be added to */
    private final ListItemClickListener mOnClickListener;


    // TODO (1) Add an interface called ListItemClickListener
    /* This interface is for list item clicks ... it doesn't do much here */
    ...
    public GreenAdapter(int numberOfItems, ListItemClickListener listItemClickListener) {
        ...
        /* Constructor must be passed a list item click listener */
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder
            implements View.OnClickListener { // TODO (5) Implement OnClickListener in the NumberViewHolder class
