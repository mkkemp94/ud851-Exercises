...
public class MainActivity extends AppCompatActivity
        implements GreenAdapter.ListItemClickListener { // TODO (8) Implement GreenAdapter.ListItemClickListener from the MainActivity
    ...
    public void onListItemClick(int listItem) {
        ...
        String toastMessage = "Clicked item: " + listItem;
