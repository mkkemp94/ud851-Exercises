...
public class VisualizerActivity extends AppCompatActivity
    ...
    private void setupSharedPreferences() {
        ...
        sharedPreferences.registerOnSharedPreferenceChangeListener(this); // the activity implements the on change listener
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        boolean newShowBassPreference = sharedPreferences.getBoolean(key, getResources().getBoolean(R.bool.pref_show_bass_default));

        if (key.equals(getString(R.string.pref_show_bass_key))) {
            mVisualizerView.setShowBass(newShowBassPreference);
        }
    }
