...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        String size = sharedPreferences.getString(getString(R.string.pref_size_key),
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(getString(R.string.pref_show_bass_key))) {
            ...
            String size = sharedPreferences.getString(key, getResources().getString(R.string.pref_size_key));
            mVisualizerView.setMinSizeScale(Float.parseFloat(size));
        }
    }
