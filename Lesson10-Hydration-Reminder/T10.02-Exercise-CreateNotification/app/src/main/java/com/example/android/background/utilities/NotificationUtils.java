...
public class NotificationUtils {
    ...
    public static final int PENDING_INTENT_ID = 404;
    public static final int NOTIFICATION_ID = 3215;
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        builder.setColor(ContextCompat.getColor(context, R.color.colorPrimary))
                ...
                .setSubText(context.getString(R.string.charging_reminder_notification_body))
