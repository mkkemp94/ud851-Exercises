...
public class ReminderTasks {
    ...
    // This will issue a notification and then increment the charging reminder count
    private static void issueChargingReminder(Context context) {

        // Increment the count by using a method that does so in preference utilities
        PreferenceUtilities.incrementChargingReminderCount(context);

        // Now send a notification, using the method that does so in NotificationUtils
